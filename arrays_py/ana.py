...
# This program generates all possible combinations of three numbers (i, j, k) where each number can be 0 or 1. 
# It then filters out the combinations where the sum of the three numbers is equal to a specified value n (in this case, n=2).
# The resulting combinations are stored in arr2 and printed at the end.
